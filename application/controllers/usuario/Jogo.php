...
class Jogo extends CI_Controller
{
	...
	public function pagina_cadastro_jogo()
	{
		...
		$this->load->view('usuario/formularioJogo', $dados);
	...
	public function pagina_edicao_jogo($id_jogo)
	{
		/** Edição */

		$dados["jogo"]  = $this->jogo_model->show($id_jogo);
		...
		$this->load->view('template/menuUsuario');
		$this->load->view('template/topNavegacao');
		$this->load->view('usuario/formularioJogo', $dados, $id_jogo);
		$this->load->view('template/footer');
	}

	public function editar_jogo($id_jogo)
	{
		// $config['upload_path']          = './assets/imagens/';
		// $config['max_size']             = 60000;
		// $config['allowed_types']        = 'jpeg|jpg|png';
		...
		$this->jogo_model->editar_jogo($id_jogo,$dados);
